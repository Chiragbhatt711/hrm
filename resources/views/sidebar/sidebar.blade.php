    ...
    <div class="sidebar-inner slimscroll">
        <div id="sidebar-menu" class="sidebar-menu">
            <ul>
                ...
                @endif
                @if (user_permission('Holidays','index') || user_permission('Leaves','index') || user_permission('Employees','index'))
                ...
                @endif
                @if(user_permission('Payroll','index'))
                ...
                @if(user_permission('Performance','index'))
                ...
                @endif
                @if (user_permission('Training List','index') || user_permission('Trainers','index') || user_permission('Training Type','index'))
                ...
                <li class="{{set_active(['profile_user'])}} submenu">
