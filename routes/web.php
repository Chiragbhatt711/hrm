...
Route::controller(HomeController::class)->group(function () {
    ...
    Route::post('/license-verify','licenseVerify')->name('license_verify');
});
...
Route::controller(LeavesController::class)->group(function () {
    ...
    Route::get('form/leaves/update/{id}/{status}','statusUpdate')->middleware('auth')->name('form/leaves/status_update');
});
...
Route::controller(AttendanceController::class)->group(function () {
    Route::get('attendance/page', 'attendanceIndex')->middleware('auth')->name('attendance/page');
    Route::post('attendance/employee_report', 'employee_report')->middleware('auth')->name('employee_report');
    Route::get('attendance/employee/page', 'AttendanceEmployee')->middleware('auth')->name('attendance/employee/page');
    Route::get('attendance/puch-in', 'PunchIn')->middleware('auth')->name('attendance/puch_in');
    Route::get('attendance/puch-out', 'PunchOut')->middleware('auth')->name('attendance/puch_out');
});
