                                            ...
                                            <td class="text-center">
                                                <div class="dropdown action-label">
                                                    ...
                                                    <div class="dropdown-menu dropdown-menu-right">
                                                        <a class="dropdown-item" href="{{ route('form/leaves/status_update', ['id' => $items->id, 'status' => 'New']) }}"><i class="fa fa-dot-circle-o text-purple"></i> New</a>
                                                        <a class="dropdown-item" href="{{ route('form/leaves/status_update', ['id' => $items->id, 'status' => 'Pending']) }}"><i class="fa fa-dot-circle-o text-info"></i> Pending</a>
                                                        <a class="dropdown-item" href="{{ route('form/leaves/status_update', ['id' => $items->id, 'status' => 'Approved']) }}"><i class="fa fa-dot-circle-o text-success"></i> Approved</a>
                                                        <a class="dropdown-item" href="{{ route('form/leaves/status_update', ['id' => $items->id, 'status' => 'Declined']) }}"><i class="fa fa-dot-circle-o text-danger"></i> Declined</a>
                                                    </div>
                                                </div>
                                            </td>
                                            <td class="text-right">
