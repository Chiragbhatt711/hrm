...
class PayrollController extends Controller
{
    ...
    {
        $admin_id = adminId();
        $users            = DB::table('users')->where('admin_id',$admin_id)->join('staff_salaries', 'users.user_id', '=', 'staff_salaries.user_id')->select('users.*', 'staff_salaries.*')->get();
        $userList         = DB::table('users')->where('admin_id',$admin_id)->get();
